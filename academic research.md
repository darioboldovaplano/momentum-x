...
Momentum-X est un projet de recherche visant à étudier la pertinence d’une approche d’investissement systématique exploitant la prime de **momentum** et **l'optimisation de portefeuille** via Mean-Variance dans un cadre d’allocation contrôlé par le risque.
